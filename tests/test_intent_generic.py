import unittest
from marmopy import IntentGeneric, Credentials
...
class IntentGenericTests(unittest.TestCase):
    ...
    def test_transfer(self):
        ...
        intent = IntentGeneric(
            ...
            signer=self.credentials.get_address(), wallet=contract_address, expiration=15
        )
    ...
    def test_balanceoff_with_wallet_generation(self):
        ...
        intent = IntentGeneric(
            data=data, contract_address=self.token_ontract_address, value=0,
            signer=self.credentials.get_address(), expiration=15
        )
    ...
    def test_balance_of_with_dependencies(self):
        ...
        intent = IntentGeneric(
            data=data, contract_address=self.token_ontract_address, value=0,
            signer=self.credentials.get_address(), wallet=contract_address,
    ...
    def test_balance_of_with_custom_salt(self):
        ...
        intent = IntentGeneric(
            ...
            value=0, signer=self.credentials.get_address(), wallet=contract_address,
