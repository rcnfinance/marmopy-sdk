...
class IntentGenericTests(unittest.TestCase):
    def setUp(self):
        ...
        self.token_ontract_address = "0x6B0F919A5d450Fa5e6283Ff6178dC1FCd195FD2A"
    ...
    def test_transfer(self):
        data = self.contract.transfer({"_to": "0x009ab4de1234c7066197d6ed75743add3576591f", "_value": 4})

        intent = IntentGeneric(
            data=data,
            contract_address=self.token_ontract_address,
            value=0,
    ...
    def test_intent_with_dependency(self):
        ...
        data = self.contract.transfer({"_to": "0x009ab4de1234c7066197d6ed75743add3576591f", "_value": 100 * 10 ** 18})
