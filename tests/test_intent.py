...
class IntentTests(unittest.TestCase):
    ...
    def test_transfer(self):
        ...
        intent = Intent(intent_action=intent_action, signer=self.credentials.get_address(), wallet=contract_address, expiration=15)
    ...
    def test_balanceoff_with_wallet_generation(self):
        ...
        intent = Intent(intent_action=intent_action, signer=self.credentials.get_address(), expiration=15)
    ...
    def test_balance_of_with_dependencies(self):
        ...
        intent = Intent(
            intent_action=intent_action, signer=self.credentials.get_address(), wallet=contract_address,
    ...
    def test_balance_of_with_custom_gas_prices(self):
        ...
        intent = Intent(intent_action=intent_action, signer=self.credentials.get_address(), wallet=contract_address,
    ...
    def test_balance_of_with_custom_salt(self):
        ...
        intent = Intent(intent_action=intent_action, signer=self.credentials.get_address(), wallet=contract_address,
                        dependencies=dependencies, salt=salt, max_gas_price=999999, min_gas_limit=300000, expiration=15)
